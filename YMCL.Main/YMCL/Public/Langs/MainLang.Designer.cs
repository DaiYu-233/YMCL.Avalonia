...
namespace YMCL.Public.Langs {
    ...
    public class MainLang {
        ...
        /// <summary>
        ///   查找类似 导出成功，数据量过大无法显示，点击复制以复制所有数据 的本地化字符串。
        /// </summary>
