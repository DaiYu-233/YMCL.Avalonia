...
public class Main : IPlugin //Do not modify
{
    public PluginInfo GetPluginInformation()
    {
        ...
        return new PluginInfo
        {
            ...
            Time = new DateTime(1970, 1, 1, 0, 0,
                0) //Plugin release time, in the format of year month day hour minute second
        };
    }
    ...
    public void OnLoad()
    {
        ...
        {
            var a = Const.Window.main.launchPage.GetControl<Button>("VersionListBtn");
    ...
    public void OnDisable()
    {
        ...
        Dispatcher.UIThread.Invoke(() => { Method.Ui.Toast("Plugin Off"); });
    }
    ...
    public void OnEnable()
    {
        ...
        //In this example, a message box pops up to prompt the user
        Dispatcher.UIThread.Invoke(() => { Method.Ui.Toast("Plugin On"); });
    }
    ...
    public void OnLaunch()
    {
        ...
        //In this example, a message box pops up to prompt the user
        Dispatcher.UIThread.Invoke(() => { Method.Ui.Toast("Game Launched"); });
    }
}