...
public class Setting: ReactiveObject
{
    ...
    [Reactive][JsonProperty] public Enum.Setting.DownloadSource DownloadSource { get; set; } = Enum.Setting.DownloadSource.Mojang;
    ...
    [Reactive][JsonProperty] public Enum.Setting.LaunchCore LaunchCore { get; set; } = Enum.Setting.LaunchCore.MinecraftLaunch;
    ...
    [Reactive][JsonProperty] public Enum.Setting.CustomHomePageWay CustomHomePage { get; set; } = Enum.Setting.CustomHomePageWay.None;
    ...
    [Reactive][JsonProperty] public JavaEntry Java { get; set; } = new() { JavaPath = "Auto", JavaVersion = "All" };
